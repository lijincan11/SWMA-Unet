...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,Mixer_num_heads=0,attention_heads=0,
        ...
        self.attn2 = Mixer(dim, num_heads=Mixer_num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, attention_head=attention_heads, pool_size=2,)
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,Mixer_num_heads, attention_heads,
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(dim=dim, input_resolution=input_resolution,
                                 ...
                                 Mixer_num_heads=Mixer_num_heads,
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.Mixer_num_heads = [3,6,12,24]
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(dim=int(embed_dim * 2 ** i_layer),
                               ...
                               Mixer_num_heads = self.Mixer_num_heads[i_layer],
                               attention_heads = self.attention_heads[i_layer],
...
class Mixer(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., attention_head=1, pool_size=2, 
        **kwargs, ):
        ...
        self.high_mixer = Max_DW(high_dim)
        self.low_mixer = Atten(low_dim, num_heads=attention_head, qkv_bias=qkv_bias, attn_drop=attn_drop, pool_size=pool_size,)
