...
parser.add_argument('--test_path', type=str,
                    default='/home/ljc/data/Synapse/test_vol_h5', help='root dir for data')
parser.add_argument("--volume_path",default='/root/li/data/ACDC/test', help='path/to/dataset/ACDC/test')
